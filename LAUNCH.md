...
1. In the Vercel project, use `www.toolstarhub.com` as the primary production domain.
2. Keep `toolstarhub.com` redirecting to `https://www.toolstarhub.com`. Canonical URLs use the www host.
...
5. Visit `https://www.toolstarhub.com` and confirm it serves the site. Confirm `https://toolstarhub.com` redirects to www.
