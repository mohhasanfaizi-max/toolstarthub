...
const workspaces: Record<string, ComponentType> = {
  ...
  "ai-prompt-generator": lazyTool(async () => (await import("./workspace/AiPromptGeneratorTool")).AiPromptGeneratorTool),
  "prompt-to-image": lazyTool(async () => (await import("./workspace/PromptToImageTool")).PromptToImageTool),
  "prompt-to-video": lazyTool(async () => (await import("./workspace/PromptToVideoTool")).PromptToVideoTool),
  "ai-article-detector": lazyTool(async () => (await import("./workspace/AiArticleDetectorTool")).AiArticleDetectorTool),
  "ai-article-compressor": lazyTool(async () => (await import("./workspace/AiArticleCompressorTool")).AiArticleCompressorTool),
  "tip-calculator": lazyTool(async () => (await import("./workspace/TipCalculatorTool")).TipCalculatorTool),
  "sales-tax-calculator": lazyTool(async () => (await import("./workspace/SalesTaxCalculatorTool")).SalesTaxCalculatorTool),
  "date-difference-calculator": lazyTool(async () => (await import("./workspace/DateDifferenceCalculatorTool")).DateDifferenceCalculatorTool),
  "find-and-replace": lazyTool(async () => (await import("./workspace/FindAndReplaceTool")).FindAndReplaceTool),
  "remove-line-breaks": lazyTool(async () => (await import("./workspace/RemoveLineBreaksTool")).RemoveLineBreaksTool),
  "add-line-numbers": lazyTool(async () => (await import("./workspace/AddLineNumbersTool")).AddLineNumbersTool),
  "json-to-csv": lazyTool(async () => (await import("./workspace/JsonToCsvTool")).JsonToCsvTool),
  "csv-to-json": lazyTool(async () => (await import("./workspace/CsvToJsonTool")).CsvToJsonTool),
  "regex-tester": lazyTool(async () => (await import("./workspace/RegexTesterTool")).RegexTesterTool),
  "hash-generator": lazyTool(async () => (await import("./workspace/HashGeneratorTool")).HashGeneratorTool),
  "compound-interest-calculator": lazyTool(async () => (await import("./workspace/CompoundInterestCalculatorTool")).CompoundInterestCalculatorTool),
  "loan-calculator": lazyTool(async () => (await import("./workspace/LoanCalculatorTool")).LoanCalculatorTool),
  "mortgage-calculator": lazyTool(async () => (await import("./workspace/MortgageCalculatorTool")).MortgageCalculatorTool),
  "auto-loan-calculator": lazyTool(async () => (await import("./workspace/AutoLoanCalculatorTool")).AutoLoanCalculatorTool),
  "home-affordability-calculator": lazyTool(async () => (await import("./workspace/HomeAffordabilityCalculatorTool")).HomeAffordabilityCalculatorTool),
