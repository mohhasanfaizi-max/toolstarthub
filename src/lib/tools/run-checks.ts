...
assert(md.ok && md.html.includes('href="https://toolstarhub.com"'), "Markdown safe link");
...
const htmlMd = htmlToMarkdown("<h2>Hello</h2><p>This is <strong>bold</strong> and <em>italic</em>.</p><ul><li>One</li></ul><script>alert(1)</script><a href=\"https://toolstarhub.com\">Site</a>");
...
assert(htmlMd.ok && htmlMd.markdown.includes("[Site](https://toolstarhub.com)"), "HTML link");
